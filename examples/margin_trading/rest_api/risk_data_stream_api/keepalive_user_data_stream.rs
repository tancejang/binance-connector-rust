...
use binance_sdk::margin_trading::{MarginTradingRestApi, rest_api::KeepaliveUserDataStreamParams};
...
async fn main() -> Result<()> {
    ...
    let params =
        KeepaliveUserDataStreamParams::builder("listen_key_example".to_string()).build()?;
