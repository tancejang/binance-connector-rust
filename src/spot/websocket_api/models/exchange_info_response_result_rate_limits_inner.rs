...
pub struct ExchangeInfoResponseResultRateLimitsInner {
...
impl ExchangeInfoResponseResultRateLimitsInner {
    #[must_use]
    pub fn new() -> ExchangeInfoResponseResultRateLimitsInner {
