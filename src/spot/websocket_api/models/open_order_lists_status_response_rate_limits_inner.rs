...
pub struct OpenOrderListsStatusResponseRateLimitsInner {
...
impl OpenOrderListsStatusResponseRateLimitsInner {
    #[must_use]
    pub fn new() -> OpenOrderListsStatusResponseRateLimitsInner {
