...
pub struct AccountRateLimitsOrdersResponseRateLimitsInner {
...
impl AccountRateLimitsOrdersResponseRateLimitsInner {
    #[must_use]
    pub fn new() -> AccountRateLimitsOrdersResponseRateLimitsInner {
