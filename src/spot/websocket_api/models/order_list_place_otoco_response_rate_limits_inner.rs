...
pub struct OrderListPlaceOtocoResponseRateLimitsInner {
...
impl OrderListPlaceOtocoResponseRateLimitsInner {
    #[must_use]
    pub fn new() -> OrderListPlaceOtocoResponseRateLimitsInner {
