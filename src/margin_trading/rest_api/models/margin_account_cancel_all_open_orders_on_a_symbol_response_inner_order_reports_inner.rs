...
impl MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrderReportsInner {
    #[must_use]
    pub fn new() -> MarginAccountCancelAllOpenOrdersOnASymbolResponseInnerOrderReportsInner {
