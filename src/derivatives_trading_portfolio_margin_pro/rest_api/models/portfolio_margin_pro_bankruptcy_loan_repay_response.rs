...
impl PortfolioMarginProBankruptcyLoanRepayResponse {
    #[must_use]
    pub fn new() -> PortfolioMarginProBankruptcyLoanRepayResponse {
        PortfolioMarginProBankruptcyLoanRepayResponse { tran_id: None }
    }
}
