...
impl CancelMarginAccountAllOpenOrdersOnASymbolResponseInnerOrderReportsInner {
    #[must_use]
    pub fn new() -> CancelMarginAccountAllOpenOrdersOnASymbolResponseInnerOrderReportsInner {
