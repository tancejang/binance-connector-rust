...
- **Official Binance Algo API docs:** [Binance API Documentation](https://developers.binance.com/docs/algo)
...
If you are upgrading from a legacy, single-crate connector that included Algo support, see the [Migration Guide](../../MIGRATION.md) for instructions on enabling the `algo` feature.
