...
impl QuerySubAccountSpotAssetsSummaryResponseSpotSubUserAssetBtcVoListInner {
    #[must_use]
    pub fn new() -> QuerySubAccountSpotAssetsSummaryResponseSpotSubUserAssetBtcVoListInner {
