...
impl WithdrawlAssetsFromTheManagedSubAccountResponse {
    #[must_use]
    pub fn new() -> WithdrawlAssetsFromTheManagedSubAccountResponse {
        WithdrawlAssetsFromTheManagedSubAccountResponse { tran_id: None }
    }
}
