...
impl GetDetailOnSubAccountsFuturesAccountV2ResponseFutureAccountRespAssetsInner {
    #[must_use]
    pub fn new() -> GetDetailOnSubAccountsFuturesAccountV2ResponseFutureAccountRespAssetsInner {
