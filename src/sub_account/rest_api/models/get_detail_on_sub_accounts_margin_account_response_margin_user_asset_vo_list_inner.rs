...
impl GetDetailOnSubAccountsMarginAccountResponseMarginUserAssetVoListInner {
    #[must_use]
    pub fn new() -> GetDetailOnSubAccountsMarginAccountResponseMarginUserAssetVoListInner {
